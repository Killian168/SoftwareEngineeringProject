...
export class FormComponent implements OnInit {
  ...
  onSubmitUserDetails(value){
    UserDets:User = new User(value.fullname, value.bio, value.birthday, value.gender);
    AccountDets:Account = new Account(value.country_phone.phone, value.email, value.matching_passwords.password, value.username);
    //this.userService.storeAccountDetails(UserDets);
  }
